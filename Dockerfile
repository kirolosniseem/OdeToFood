...
COPY ["OdeToFoodData/OdeToFoodData.csproj", "OdeToFoodData/"]
COPY ["OdeToFoodBusiness/OdeToFoodBusiness.csproj", "OdeToFoodBusiness/"]
COPY ["UsersIdentity/UsersIdentity.csproj", "UsersIdentity/"]
